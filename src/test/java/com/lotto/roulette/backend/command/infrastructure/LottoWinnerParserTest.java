...
class LottoWinnerParserTest {
    ...
    class ConvertTest {
        ...
        void 성공한다() {
            ...
            // when
            LottoWinnerInfo result = LottoWinnerParser.parseLottoWinnerInfo(lottoWinnerInfo);
        ...
        void 실패한다() {
            ...
            // when then
            assertThatThrownBy(() -> LottoWinnerParser.parseLottoWinnerInfo(invalidJson))
